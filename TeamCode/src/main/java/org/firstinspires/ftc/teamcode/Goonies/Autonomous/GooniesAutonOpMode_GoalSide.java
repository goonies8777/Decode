...
@Autonomous(name="Goonies Blue Goal Side", group="Goonies", preselectTeleOp="MiniVinnie")
public class GooniesAutonOpMode_GoalSide extends LinearOpMode {
    IRobot _robot;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        driveTrain.driveLeftForMiliseconds(800);
    }
