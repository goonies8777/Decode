...
@Autonomous(name="Goonies Red Goal Side", group="Goonies", preselectTeleOp="MiniVinnie")
public class GooniesAutonOpMode_GoalSide_Red extends LinearOpMode {
    IRobot _robot;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        driveTrain.driveForwardForMiliseconds(750);

        driveTrain.driveRightForMiliseconds(800);
    }
