...
@Autonomous(name="Goonies Red Launch Side", group="Goonies", preselectTeleOp="MiniVinnie")
public class GooniesAutonOpMode_LaunchSide_Red extends LinearOpMode {
    IRobot _robot;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        driveTrain.driveLeftForMiliseconds(500);
    }
